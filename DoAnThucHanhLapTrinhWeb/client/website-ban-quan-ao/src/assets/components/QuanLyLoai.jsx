...
export default function QuanLyLoai() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetch("http://localhost/ThucHanhLapTrinhWeb/DoAnThucHanhLapTrinhWeb/server/product/addCategory.php", {
            method: 'POST',
            headers: {
    ...
    const handleDelete = (id) => {
        fetch("http://localhost/ThucHanhLapTrinhWeb/DoAnThucHanhLapTrinhWeb/server/product/deleteCategory.php", {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const handleUpdate = (e) => {
        ...
        fetch("http://localhost/ThucHanhLapTrinhWeb/DoAnThucHanhLapTrinhWeb/server/product/updateCategory.php", {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
                ...
                <tbody>
                    {categories.length > 0 && categories.map((value) => (
                        <tr key={value.category_id}>
                            ...
                            <td>
                                <button
                                    onClick={() => openEdit(value.category_id, value.category_name)}
                                    style={{
                                        marginRight: '10px',
                                        padding: '8px 12px',
