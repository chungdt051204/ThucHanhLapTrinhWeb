...
<!-- Khi bấm submit dữ liệu sẽ được gửi đến file 2.php thông qua method POST -->
 <!-- enctype="multipart/form-data" cho phép gửi dữ liệu file  -->
<form action="2.php" method="post" enctype="multipart/form-data">
    <!-- Dữ liệu form là 1 table  -->
<table  align="center">
    ...
    <tr><td>Giới tính:</td><td><input type="radio" name="gt" value="1" checked="checked">Nam
              ...
              <!-- Thêm multiple để cho phép upload nhiều hình ảnh -->
    <tr><td>Hình:</td><td><input type="file" name="hinh[]" multiple /></td></tr>
