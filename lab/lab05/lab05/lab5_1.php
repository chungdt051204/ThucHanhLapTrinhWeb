...
<body>
<?php
print_r($_GET);//Mảng $_GET hiển thị dữ liệu sau khi người dùng click vào 4 link bên dưới hoặc khi submit form method GET
?><hr>
...
<!-- Khi bấm submit url sẽ có dạng localhost:3000/?x=1&y=2&z=3 và được lưu vào mảng $_GET -->
...
<!-- Khi bấm submit url sẽ có dạng localhost:3000/?x[]=1&x[]=2&y=3 và được lưu vào mảng $_GET -->
<form action="lab5_1.php" method="get">
...
<!-- Ví dụ nhập tên Chung, giới tính Nam, Sơ thích: Thể thao thì khi
 submit url sẽ có dạng localhost:3000/?ten=chung&gt=1&st[]=tt -->
<form action="lab5_1.php" method="get">
